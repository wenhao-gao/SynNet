"""
This file contains a function to decode a single synthetic tree  # TODO update description (how is this different from the others?)
"""
import pandas as pd
import numpy as np
...
def func(smi):
    emb = mol_fp(smi)
    try:
        smi, similarity, tree, action = synthetic_tree_decoder_multireactant(emb, building_blocks, bb_dict, rxns, mol_fp, act_net, rt1_net, rxn_net, rt2_net, bb_emb=bb_emb, beam_width=3, rxn_template=rxn_template, n_bits=nbits, max_step=15)

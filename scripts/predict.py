...
if __name__ == '__main__':
    ...
    def synthetic_tree_decoder(z_target : np.ndarray, 
        ...
        for i in range(max_step):
            ...
            z_mol1 = mol_fp(mol1, radius=args.radius, nBits=args.nbits)
    ...
    path_to_reaction_file = '/pool001/whgao/data/synth_net/st_' + args.rxn_template + '/reactions_' + args.rxn_template + '.json.gz'
    path_to_building_blocks = '/pool001/whgao/data/synth_net/st_' + args.rxn_template + '/enamine_us_matched.csv.gz'

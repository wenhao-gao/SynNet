...
def get_args():
    ...
    parser.add_argument("--group", default="rt2", type=str)
    parser.add_argument("--result_dir", default="results/ft/rt2", type=str)

    # Sweep?
    parser.add_argument("--sweep_config", type=str)

    # launcher_args
    parser.add_argument("--script_name", default="src/synnet/models/rt2.py", type=str)
    ...
    parser.add_argument("--input_dim", default=16475, type=int)

...
def get_args():
    ...
    # launcher_args
    parser.add_argument("--script_name", default="src/synnet/models/rxn.py", type=str)
    ...
    parser.add_argument("--input_dim", default=16384, type=int)
    parser.add_argument("--output_dim", default=91, type=int)  # hartenfeller-burton
